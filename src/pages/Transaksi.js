          ...
          return (
            <View style={{
             ...
             <View style={{
              ...
              <Text style={{
                ...
                fontSize:12
              }}>Nama Obat : {item.nama_obat}</Text>
              <Text style={{
                fontFamily:fonts.secondary[600],
                color:colors.black,
                fontSize:12
              }}>Dosis : {item.dosis}</Text>
            ...
            <Text style={{
              ...
              <Text style={{
                ...
                color:colors.black,
                fontSize:12
              }}>Waktu Alarm : {item.waktu_alarm}</Text>

                 <Text style={{
                fontFamily:fonts.secondary[600],
                color:colors.black,
                fontSize:12
              }}>Waktu Minum : {item.waktu_minum}</Text>
             </View>
             <View style={{
                width:80,
