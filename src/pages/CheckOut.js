            ...
            <View style={styles.productInfo}>
              ...
              <View style={styles.quantityContainer}>
                <TouchableOpacity
                  ...
                  <MyIcon name="remove-circle" size={24} color={colors.primary} />
                </TouchableOpacity>
                <Text style={styles.quantityText}>{quantity}</Text>
                <TouchableOpacity onPress={() => setQuantity(quantity + 1)}>
                  <MyIcon name="add-circle" size={24} color={colors.primary} />
                </TouchableOpacity>
              </View>
            </View>
          </View>
            ...
            <View
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  <MyIcon type="ionicon" name="copy" size={20} />
                </TouchableOpacity>
              </View>
            </View>
            <View
